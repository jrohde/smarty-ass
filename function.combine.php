        ...
        function smarty_build_combine($params)
        {
            ...
            if ($params['debug'] == true) {
                ...
                foreach ($filelist as $file) {
                    if ($params['type'] == 'js') {
                        $output_filename .= '<script type="text/javascript" src="//'.$_SERVER['SERVER_NAME'].$file['name'].'" charset="utf-8"></script>';
                    } elseif ($params['type'] == 'css') {
                        $output_filename .= '<link type="text/css" rel="stylesheet" href="//'.$_SERVER['SERVER_NAME'].$file['name'].'" />';
                    }
                }
